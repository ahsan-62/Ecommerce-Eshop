    ...
    <meta name="msapplication-square150x150logo"
        content="{{ asset('assets/backend/img') }}/favicon/mstile-150x150.png" />
    <meta name="msapplication-wide310x150logo"
        content="{{ asset('assets/backend/img') }}/favicon/mstile-310x150.png" />
    <meta name="msapplication-square310x310logo"
        content="{{ asset('assets/backend/img') }}/favicon/mstile-310x310.png" />
    <!-- Favicon Tags End -->
    <!-- Font Tags Start -->
